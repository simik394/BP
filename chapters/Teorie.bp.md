...
## pojmy získané z báze chystamprogram
...
## pojmy získané z báze encyklopedie her
Jelikož v rámci hledání pojmů ve 'Velké encyklopedii her' bylo prohledáno několik jejích částí, bude i výčet pojmů rozdělen podle těchto částí. Na úvod budou představeny pojmy získané z doporučení pro zapisování tradičních her, nacházejícím se v Úvodní kapitole čtvrté z knih. Následovat bude představení pojmů získaných z názvů kapitol jednotlivých knih, a na závěr pojmů získaných ze symbolického značení definovaným shodně ve všech knihách. 
### Pojmy získané z doporučení pro zapisování tradičních her jsou 
...
### V symbolickém značení u jednotlivých her je potom zachyceno:
...
## Představení vybraných kandidátů
