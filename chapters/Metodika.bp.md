...
Aby bylo možné ve vytvořeném konceptuálním modelu zohlednit i pohled této báze, bude na závěr prezentovaných výsledků ze systematické analýzy prvních dvou bází v teoretické části, doplněn stručný popis zapsaného obsahu na sdíleném disku, spolu s identifikovanými klíčovými pojmy, které by měly být zakomponovány do modelu pojmů.
### analýza
